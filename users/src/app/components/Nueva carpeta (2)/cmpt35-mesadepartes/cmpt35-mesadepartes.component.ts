  ...
  @Component({
    selector: 'app-cmpt35-mesadepartes',
    templateUrl: './cmpt35-mesadepartes.component.html',
    styleUrls: ['./cmpt35-mesadepartes.component.css']
  })
  export class Cmpt35MESADEPARTESComponent implements OnInit {
    public title!: string;
    ...
    gets(){
    this.Service.gets("MESADEPARTES")
    .subscribe(
    (res: any) => {
    this.data = res;
    console.log(res);
    ...
    create() {
    this.Service.save(localStorage.getItem('id') || "", "MESADEPARTES")
    .subscribe(
    (res: any) => {
    console.log(res);
    this.gets()
