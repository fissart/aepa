    ...
    @Component({
      selector: 'app-cmpt17-administrativos',
      templateUrl: './cmpt17-administrativos.component.html',
      styleUrls: ['./cmpt17-administrativos.component.css']
    })
    export class Cmpt17ADMINISTRATIVOSComponent implements OnInit {
    ...
    gets(){
    this.Service.gets("ADMINISTRATIVOS")
    .subscribe(
    (res: any) => {
    this.data = res;
    console.log(res);
    ...
    create() {
    this.Service.save(localStorage.getItem('id') || "", "ADMINISTRATIVOS")
    .subscribe(
    (res: any) => {
    console.log(res);
    this.gets()
