...
@Component({
  selector: 'app-w-www',
  templateUrl: './w-www.component.html',
  styleUrls: ['./w-www.component.css']
})
export class WWwwComponent implements OnInit {
  public title!: string;
  ...
  create() {
  this.Service.save(localStorage.getItem('id') || "", "W_www")
  .subscribe(
  (res: any) => {
  console.log(res);
  this.gets()
