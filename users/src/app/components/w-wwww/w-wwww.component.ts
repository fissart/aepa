...
@Component({
  selector: 'app-w-wwww',
  templateUrl: './w-wwww.component.html',
  styleUrls: ['./w-wwww.component.css']
})
export class WWwwwComponent implements OnInit {
  public title!: string;
  ...
  create() {
  this.Service.save(localStorage.getItem('id') || "", "W_wwww")
  .subscribe(
  (res: any) => {
  console.log(res);
  this.gets()
