...
@Component({
  selector: 'app-w-w',
  templateUrl: './w-w.component.html',
  styleUrls: ['./w-w.component.css']
})
export class WWComponent implements OnInit {
  public title!: string;
  ...
  create() {
  this.Service.save(localStorage.getItem('id') || "", "W_w")
  .subscribe(
  (res: any) => {
  console.log(res);
  this.gets()
